...
public class TestEvalDataCleanseService {
    ...
    public void testGetUser() {
        ...
        String userId = "";
        try {
            userId = evalDataCleanseService.getUser(dbObject);
        } catch (Exception e) {
        }
    ...
    public void testGetDemographics() {
        ...
        DBObject dbObject = getDBObject(jsonObject);
        try {
            String userId = evalDataCleanseService.getUser(dbObject);
    ...
    public void testGetAppName() {
        ...
        DBObject dbObject = getDBObject(jsonObject);
        try {
            String appName = evalDataCleanseService.getAppName(dbObject);
    ...
    public void testNetwork() {
        ...
        DBObject dbObject = getDBObject(jsonObject);
        try {
            String network = evalDataCleanseService.getNetwork(dbObject);
    ...
    public void testGetDayOfWeek() {
        ...
        DBObject dbObject = getDBObject(jsonObject);
        try {
            String dayOfWeek = evalDataCleanseService.getDayofWeek(dbObject);
    ...
    public void testTimeOfDay() {
        ...
        DBObject dbObject = getDBObject(jsonObject);
        try {
            String timeOfDay = evalDataCleanseService.getTimeOfDay(dbObject);
    ...
    public void testGetFrequentLocation() {
        ...
        try {
            ...
            DB db = evalDataCleanseService.getConnection("mongodb://smartsecureteam:SJSU2016@ds015909.mlab.com:15909/smartsecure");
            DBCollection collection = evalDataCleanseService.getCollection(db, "MasterUserTable");
            String frequentLocation = evalDataCleanseService.getFrequentLoc(userId, collection, getDBObject(jsonObject));
    ...
    private DBObject getDBObject(JSONObject jsonObject) {
        DBObject dbObject = new BasicDBObject();
        for (String key : jsonObject.keySet()) {
            dbObject.put(key, jsonObject.get(key));
        }
        return dbObject;
    }
